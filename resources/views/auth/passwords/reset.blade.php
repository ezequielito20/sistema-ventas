                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="email" name="email" type="email" required
                                ...
                                placeholder="{{ __('your@email.com') }}" value="{{ $email ?? old('email') }}">
                            @error('email')
                        ...
                        <div>
                            <label for="password" class="block text-sm font-medium text-white mb-2">
                                <i class="fas fa-lock mr-2"></i>{{ __('New Password') }}
                            </label>
                        ...
                        <!-- Confirm Password -->
                        <div>
                            <label for="password-confirm" class="block text-sm font-medium text-white mb-2">
                                <i class="fas fa-check-double mr-2"></i>{{ __('Confirm Password') }}
                            </label>
                        ...
                        <div>
                            <button type="submit"
                                ...
                                <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                                    <i class="fas fa-save text-indigo-600 group-hover:text-indigo-700"></i>
                                </span>
                                {{ __('Reset Password') }}
                            </button>
                        </div>

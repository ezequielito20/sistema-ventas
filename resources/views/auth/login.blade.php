                            ...
                            @if (Route::has('password.request'))
                                <div class="text-sm">
                                    <a href="{{ route('password.request') }}"
                                        class="font-medium text-white hover:text-white/80 transition-colors duration-300">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                if (typeof Swal !== 'undefined') {
                    Swal.fire({
                        title: icon === 'success' ? '{{ __('Success!') }}' : icon === 'error' ?
                            '{{ __('Error') }}' : '{{ __('Information') }}',
                        text: message,
                        icon: icon,

<div class="space-y-6" wire:key="permissions-index-root">
    ...
    <div class="ui-panel">
        <div class="ui-panel__body space-y-4">
            {{--
              Una sola fila: flex-nowrap + min-w-0 en la búsqueda + anchos fijos en selects (sin w-full en el contenedor flex de cada uno salvo dentro del bloque fijo).
              Si el panel es muy estrecho, scroll horizontal en lugar de bajar Guard a otra línea.
            --}}
            <div class="-mx-1 overflow-x-auto overflow-y-visible px-1 pb-0.5 sm:mx-0 sm:px-0">
                <div class="flex w-max min-w-full flex-nowrap items-end gap-2 sm:gap-3">
                    ...
                    <div class="w-[9.25rem] shrink-0 xs:w-40 sm:w-44">
                    ...
                    <div class="w-[7rem] shrink-0 sm:w-28">

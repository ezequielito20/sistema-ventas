...
<div class="space-y-6" wire:key="sales-index">
    ...
    <div class="ui-panel" x-data="{ showFilters: false }">
        ...
        <div class="ui-panel__body space-y-4" x-show="showFilters" x-transition>
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:items-end xl:grid-cols-[repeat(2,minmax(0,0.9fr))_repeat(2,minmax(0,0.85fr))_auto]">
                {{-- Desde --}}
                <div>
                ...
                <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center lg:w-auto">
                    <div class="relative min-w-[16rem] flex-1 lg:min-w-[18rem]">
                        ...
                        <input type="search" wire:model.live.debounce.300ms="search"
                            placeholder="Buscar cliente, fecha, monto o producto…"

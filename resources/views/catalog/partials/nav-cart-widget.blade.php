<div x-show="cartUrls.sync"
    ...
    <div x-show="cartPanelOpen"
         ...
         x-transition:leave-end="opacity-0 translate-y-0.5 scale-[0.99]"
         class="catalog-cart-popover isolate flex max-h-[inherit] min-h-0 flex-col outline-none ring-1 ring-transparent"

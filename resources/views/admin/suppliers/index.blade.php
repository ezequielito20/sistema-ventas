...
@section('content')
    ...
    <div class="main-container">
            ...
            <div class="header-content">
                ...
                <div class="header-actions">
                    @if ($permissions['suppliers.report'])
                        <a href="{{ route('admin.suppliers.report') }}" class="btn-glass btn-secondary-glass"
                            target="_blank">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-2 sm:gap-3 mb-6">
            ...
            <x-dashboard-widget title="Total de Proveedores" value="{{ $totalSuppliers }}" valueType="number"
                icon="fas fa-truck" trend="Registrados" trendIcon="fas fa-plus-circle" trendColor="text-green-300"
            ...
            <!-- Proveedores Activos -->
            <x-dashboard-widget title="Proveedores Activos" value="{{ $activeSuppliers }}" valueType="number"
                icon="fas fa-check-circle" trend="Activos" trendIcon="fas fa-check" trendColor="text-green-300"
            ...
            <x-dashboard-widget title="Este Mes" value="{{ $recentSuppliers }}" valueType="number" icon="fas fa-user-plus"
                trend="Nuevos" trendIcon="fas fa-calendar-month" trendColor="text-yellow-300"
            ...
            <x-dashboard-widget title="Inactivos" value="{{ $inactiveSuppliers }}" valueType="number"
                icon="fas fa-user-slash" trend="Inactivos" trendIcon="fas fa-pause-circle" trendColor="text-red-300"
                    ...
                    <div class="content-actions">
                        <div class="search-container">
                            <div class="search-wrapper">
                                ...
                                <input type="text" placeholder="Buscar proveedores..." id="searchInput"
                        ...
                        <div class="cards-grid" id="cardsGrid">
                            @foreach ($suppliers as $supplier)
                                <div class="supplier-card" data-supplier-id="{{ $supplier->id }}"
                                    data-search="{{ strtolower($supplier->company_name . ' ' . $supplier->supplier_name . ' ' . $supplier->company_address) }}">
                                    ...
                                    <div class="card-actions">
                                        @if ($permissions['suppliers.show'])
                                            <button type="button" class="card-btn card-btn-view"
                                                onclick="showSupplierDetails({{ $supplier->id }})" title="Ver Detalles">
                                        ...
                                        @if ($permissions['suppliers.destroy'])
                                            <button type="button" class="card-btn card-btn-delete"
                                                onclick="deleteSupplier({{ $supplier->id }}, '{{ $supplier->company_name }}')"
                                                title="Eliminar">
                                        ...
                                        <tr class="table-row" data-supplier-id="{{ $supplier->id }}">
                                            ...
                                            <td>
                                                <div class="location-info">
                                                    <span
                                                        class="location-text">{{ Str::limit($supplier->company_address, 50) }}</span>
                                                </div>
                                            </td>
                                            <td>

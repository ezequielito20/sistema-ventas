                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-4 mb-4">
                            <div
                                class="w-12 h-12 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Actualice los campos que desee modificar para el cliente: <strong
                                    class="text-blue-600">{{ $customer->name }}</strong></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submitForm()" class="p-6 space-y-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" id="name" name="name" x-model="form.name"
                                @input="handleNameInput($event); validateField('name')" @blur="validateField('name')"
                                :class="getFieldClasses('name')" placeholder="Ingrese el nombre completo" required
                                autofocus>
                            ...
                            <div x-show="!errors.name && form.name"
                                class="mt-2 flex items-center space-x-2 text-sm text-green-600">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="text" id="nit_number" name="nit_number" x-model="form.nit_number"
                                @input="validateField('nit_number')" @blur="validateField('nit_number')"
                                :class="getFieldClasses('nit_number')" placeholder="Ingrese la Cédula">
                            <div x-show="errors.nit_number" x-cloak
                                class="mt-2 flex items-center space-x-2 text-sm text-red-600">
                                <i class="fas fa-exclamation-circle"></i>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="tel" id="phone" name="phone" x-model="form.phone"
                                @input="handlePhoneInput($event); validateField('phone')" @blur="validateField('phone')"
                                :class="getFieldClasses('phone')" placeholder="(123) 456-7890" maxlength="10"
                                autocomplete="off">
                            <div x-show="errors.phone" x-cloak
                                class="mt-2 flex items-center space-x-2 text-sm text-red-600">
                                <i class="fas fa-exclamation-circle"></i>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <input type="email" id="email" name="email" x-model="form.email"
                                ...
                                :class="getFieldClasses('email')" placeholder="ejemplo@correo.com">
                            <div x-show="errors.email" x-cloak
                                class="mt-2 flex items-center space-x-2 text-sm text-red-600">
                                <i class="fas fa-exclamation-circle"></i>
                                <span x-text="errors.email"></span>
                            </div>
                            <div x-show="!errors.email && form.email"
                                class="mt-2 flex items-center space-x-2 text-sm text-green-600">
                                <i class="fas fa-check-circle"></i>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <div class="flex items-center space-x-3">
                                <input type="number" step="0.01" min="0" id="total_debt" name="total_debt"
                                    x-model="form.total_debt" @input="validateField('total_debt')"
                                    @blur="validateField('total_debt')" :class="getFieldClasses('total_debt')"
                                    :disabled="!debtEditable"
                                    :aria-describedby="debtEditable ? 'debt-edit-enabled' : 'debt-edit-disabled'"
                                    placeholder="0.00" class="flex-1">
                                <button type="button" @click="toggleDebtEdit()"
                                    :class="debtEditable ? 'bg-gradient-to-r from-green-600 to-emerald-600' :
                            ...
                            <div x-show="errors.total_debt" x-cloak
                                class="mt-2 flex items-center space-x-2 text-sm text-red-600">
                                <i class="fas fa-exclamation-circle"></i>
                            ...
                            <div class="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div class="text-sm text-yellow-800">
                                        <p class="font-medium">La deuda se calcula automáticamente según las ventas y
                                            pagos.</p>
                            ...
                            <div id="debt-edit-disabled" x-show="!debtEditable" x-cloak class="sr-only">
                                Campo de deuda deshabilitado. Haga clic en el botón de candado para habilitar la edición
                                manual.
                            </div>
                            <div id="debt-edit-enabled" x-show="debtEditable" x-cloak class="sr-only">
                                Campo de deuda habilitado para edición manual. Haga clic en el botón de candado para
                                deshabilitar.
                            </div>
                        </div>
                    </div>

...
@section('content')
    <div x-data="paymentHistory()" class="space-y-6">
                ...
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex-1">
                        <div class="flex items-center space-x-3 mb-3">
                            <div
                                class="w-10 h-10 bg-blue-600 bg-opacity-90 rounded-lg flex items-center justify-center shadow-lg">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right">
                            <h3 class="text-2xl font-bold text-white">{{ $currency->symbol }}
                                {{ number_format($totalRemainingDebt, 2) }}</h3>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div x-show="viewMode === 'table' && window.innerWidth >= 768" x-cloak
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 sm:gap-4">
                    <template x-for="payment in paginatedPayments" :key="payment.id">
                        <div
                            ...
                            <div
                                class="bg-gradient-to-r from-blue-50 to-purple-50 px-3 sm:px-4 py-3 border-b border-gray-100">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-2">
                                        <div
                                            class="w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center shadow-sm">
                            ...
                            <div class="p-3 sm:p-4">
                                ...
                                <div class="mb-3">
                                    <div class="flex items-center space-x-2 mb-2">
                                        <div
                                            class="w-6 h-6 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center">
                                            <i class="fas fa-user text-white text-xs"></i>
                                        </div>
                                        <div class="min-w-0 flex-1">
                                            <label

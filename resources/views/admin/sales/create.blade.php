                    ...
                    <div class="relative bg-white rounded-3xl shadow-2xl max-w-7xl w-full max-h-[90vh] overflow-hidden"
                        ...
                        <div class="bg-gray-50 px-8 py-4 border-b border-gray-200">
                            <div class="flex items-center space-x-4">
                                ...
                                <button @click="clearSearch()" x-show="productSearchTerm.length > 0"
                                        ...
                                        <tbody class="divide-y divide-gray-200">
                                            <template x-for="product in filteredProducts" :key="product.id">
                                                <tr class="transition-colors duration-200"
                                                    :class="isProductInSale(product.id) ? 'bg-green-50 hover:bg-green-100' :
                                                        'hover:bg-gray-50'">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                                        <button type="button" @click="addProductToSale(product)"
                                                            ...
                                                            :title="product.stock <= 0 ? 'Sin stock' : (isProductInSale(product
                                                                    .id) ? 'Ya agregado a la venta' :
                                                                'Agregar a la venta')">
                                                            <i class="fas fa-plus text-sm"></i>
                                                        </button>
                                                    </td>

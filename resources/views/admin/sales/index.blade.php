                                            ...
                                            <div class="flex items-center justify-end space-x-2">
                                                ...
                                                @if ($permissions['can_print'])
                                                    <button type="button"
                                                        ...
                                                        @click="printSale({{ $sale->id }})" title="Imprimir">
                                    ...
                                    <tr>
                                        <td colspan="7" class="px-6 py-12 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <h3 class="text-lg font-medium text-gray-900 mb-2">No hay ventas
                                                    registradas</h3>
                                ...
                                <div class="card-content">
                                    <div class="info-row">
                                        <div class="info-item">
                                            ...
                                            <span
                                                class="info-value">{{ $sale->customer->name ?? 'Cliente no especificado' }}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="card-actions">
                                    @if ($permissions['can_show'])
                                        <button type="button" class="btn-action btn-view"
                                            @click="showSaleDetails({{ $sale->id }})" title="Ver detalles">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                    @endif
                                    @if ($permissions['can_edit'])
                                        <a href="{{ route('admin.sales.edit', $sale->id) }}" class="btn-action btn-edit"
                                            title="Editar venta">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                    @endif
                                    ...
                                    <div class="pagination-numbers">
                                        ...
                                        @if ($end < $lastPage)
                                            ...
                                            <a href="{{ $sales->url($lastPage) }}"
                                                class="pagination-number">{{ $lastPage }}</a>
                                        @endif
                                    </div>

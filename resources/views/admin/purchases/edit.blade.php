...
@section('content')
    ...
    <!-- Main Container -->
    <div class="main-container" x-data="purchaseForm()" data-currency-symbol="{{ $currency->symbol }}"
        data-initial-products='@json($purchaseDetails)'
        data-general-discount-value="{{ $purchase->general_discount_value }}"
        data-general-discount-type="{{ $purchase->general_discount_type }}"
        data-total-products="{{ $purchaseDetails->count() }}" data-total-quantity="{{ $purchaseDetails->sum('quantity') }}"
        data-total-amount="{{ $purchaseDetails->sum('subtotal') }}" data-referrer-url="{{ session('purchases_referrer') }}"
                                ...
                                <div class="header-content">
                                    ...
                                    <div class="header-controls">
                                        <div class="product-counter">
                                            <span class="counter-badge" id="productCount">{{ $purchase->details->count() }}
                                                productos</span>
                                        </div>
                                    </div>
                                </div>

...
<body>
        ...
        <tbody>
            @foreach ($purchases as $purchase)
                <tr>
                    ...
                    <td>{{ $purchase->payment_receipt ?? 'Sin comprobante' }}</td>
                    <td style="text-align: right">{{ $currency->symbol }} {{ number_format($purchase->total_price, 2) }}
                    </td>
    ...
    <div class="total-section">
        <p>
            <strong>Total en Compras:</strong>
            {{ $currency->symbol }} {{ number_format($purchases->sum('total_price'), 2) }}
        </p>
    </div>

                                        ...
                                        <div class="input-container">
                                            <div class="input-wrapper">
                                                ...
                                                <input type="time" 
                                                       ...
                                                       value="{{ old('purchase_time', date('H:i')) }}" 
                                                       required>
                                                <div class="input-border"></div>
                                                <div class="input-focus-effect"></div>
                                            </div>
                    ...
                    <div class="form-card">
                        ...
                        <div class="card-body">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <template x-for="(product, index) in products" :key="product.id">
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <span class="text-gray-500 mr-2">{{$currency->symbol}}</span>
                                                        <input type="number" 
                                                               :value="product.price"
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-green-600">
                                                    <span x-text="'{{$currency->symbol}} ' + product.subtotal.toFixed(2)"></span>
                                                </td>
                            ...
                            <div x-show="products.length === 0" 
                                ...
                                <p class="text-gray-500 mb-3">Escanee un producto o use el botón "Buscar" para agregar productos a la compra</p>
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 max-w-md mx-auto">
                                    <div class="flex items-center">
                                        <i class="fas fa-info-circle text-blue-500 mr-2"></i>
                                        <p class="text-sm text-blue-700">
                                            <strong>Consejo:</strong> Si solo hay un producto con stock disponible, se agregará automáticamente.
                                        </p>
                                    </div>
                        ...
                        <div class="card-section">
                            ...
                            <div class="summary-stats">
                                ...
                                <div class="summary-item total">
                                    ...
                                    <div class="summary-content">
                                        <div class="summary-value total-amount" x-text="'{{$currency->symbol}} ' + totalAmount.toFixed(2)">{{$currency->symbol}} 0.00</div>
                            ...
                            @foreach ($products as $product)
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <span>{{$currency->symbol}} {{ number_format($product->purchase_price, 2) }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full

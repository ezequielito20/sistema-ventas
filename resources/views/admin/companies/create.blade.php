...
@push('css')
    <link rel="stylesheet" href="{{ asset('css/admin/companies/create.css') }}">
@endpush

@push('js')
    <script src="{{ asset('js/admin/companies/create.js') }}" defer></script>
@endpush
        ...
        <div class="form-body">
            <form action="{{ route('admin.company.store') }}" method="POST" enctype="multipart/form-data" id="companyForm">
                ...
                <div class="form-actions">
                    ...
                    <button type="button" onclick="window.companyCreate.goBack()" class="btn btn-secondary">
